...
namespace Infrastructure
{
    public static class DataSeeder
    {
        public static async Task SeedAllAsync(IServiceProvider services)
        {
            ...
            // ========== SHOPS ==========
            var shop1 = new Shop { Id = Guid.Parse("51000000-0000-0000-0000-000000000001"), OwnerId = shopOwner1.Id, ShopName = "Tiệm Bánh Ngọt Ngào", Description = "Chuyên bánh sinh nhật, bánh kem tươi cao cấp", AvatarUrl = "https://picsum.photos/seed/shop1/200", BannerUrl = "https://picsum.photos/seed/shop1b/800/300", Address = "123 Nguyễn Huệ, Quận 1, TP.HCM", ProvinceId = 1, DistrictId = 1, WardCode = "1", Phone = "02812345678", CommissionRate = 5.00m, IsActive = true, CreatedAt = now, UpdatedAt = now };
            var shop2 = new Shop { Id = Guid.Parse("51000000-0000-0000-0000-000000000002"), OwnerId = shopOwner2.Id, ShopName = "Bakery Hạnh Phúc", Description = "Bánh mì, croissant, pastry kiểu Pháp", AvatarUrl = "https://picsum.photos/seed/shop2/200", BannerUrl = "https://picsum.photos/seed/shop2b/800/300", Address = "456 Lê Lợi, Quận 1, TP.HCM", ProvinceId = 1, DistrictId = 1, WardCode = "2", Phone = "02887654321", CommissionRate = 5.00m, IsActive = true, CreatedAt = now, UpdatedAt = now };
            var shop3 = new Shop { Id = Guid.Parse("51000000-0000-0000-0000-000000000003"), OwnerId = shopOwner3.Id, ShopName = "Sweet Dream Pastry", Description = "Cupcake, macaron và dessert phong cách Nhật", AvatarUrl = "https://picsum.photos/seed/shop3/200", BannerUrl = "https://picsum.photos/seed/shop3b/800/300", Address = "789 Trần Hưng Đạo, Quận 5, TP.HCM", ProvinceId = 1, DistrictId = 5, WardCode = "74", Phone = "02811223344", CommissionRate = 3.00m, IsActive = true, CreatedAt = now, UpdatedAt = now };
            ...
            // ========== ORDERS ==========
            var ord1 = new Order { Id = Guid.Parse("0d000000-0000-0000-0000-000000000001"), UserId = cust1.Id, ShopId = shop1.Id, ShippingAddressId = addr1.Id, Subtotal = 830000m, TotalAmount = 830000m, Status = "Completed", PaymentMethod = "Wallet", PaymentStatus = "Paid", Note = "Giao trước 5h chiều", CreatedAt = now.AddDays(-10), UpdatedAt = now.AddDays(-8) };
            var ord2 = new Order { Id = Guid.Parse("0d000000-0000-0000-0000-000000000002"), UserId = cust1.Id, ShopId = shop2.Id, ShippingAddressId = addr1.Id, Subtotal = 135000m, TotalAmount = 135000m, Status = "Completed", PaymentMethod = "Wallet", PaymentStatus = "Paid", CreatedAt = now.AddDays(-7), UpdatedAt = now.AddDays(-5) };
            var ord3 = new Order { Id = Guid.Parse("0d000000-0000-0000-0000-000000000003"), UserId = cust2.Id, ShopId = shop1.Id, ShippingAddressId = addr3.Id, Subtotal = 2500000m, TotalAmount = 2500000m, Status = "Confirmed", PaymentMethod = "Wallet", PaymentStatus = "Paid", Note = "Bánh cưới cho ngày 15/3", CreatedAt = now.AddDays(-3), UpdatedAt = now.AddDays(-2) };
            var ord4 = new Order { Id = Guid.Parse("0d000000-0000-0000-0000-000000000004"), UserId = cust3.Id, ShopId = shop3.Id, ShippingAddressId = addr4.Id, Subtotal = 570000m, TotalAmount = 570000m, Status = "Shipping", PaymentMethod = "Wallet", PaymentStatus = "Paid", CreatedAt = now.AddDays(-2), UpdatedAt = now.AddDays(-1) };
            var ord5 = new Order { Id = Guid.Parse("0d000000-0000-0000-0000-000000000005"), UserId = cust4.Id, ShopId = shop2.Id, ShippingAddressId = addr5.Id, Subtotal = 420000m, TotalAmount = 420000m, Status = "Pending", PaymentMethod = "Wallet", PaymentStatus = "Pending", CreatedAt = now.AddDays(-1), UpdatedAt = now.AddDays(-1) };
            var ord6 = new Order { Id = Guid.Parse("0d000000-0000-0000-0000-000000000006"), UserId = cust5.Id, ShopId = shop3.Id, ShippingAddressId = addr6.Id, Subtotal = 320000m, TotalAmount = 320000m, Status = "Completed", PaymentMethod = "Wallet", PaymentStatus = "Paid", CreatedAt = now.AddDays(-15), UpdatedAt = now.AddDays(-12) };
            var ord7 = new Order { Id = Guid.Parse("0d000000-0000-0000-0000-000000000007"), UserId = cust2.Id, ShopId = shop2.Id, ShippingAddressId = addr3.Id, Subtotal = 180000m, TotalAmount = 180000m, Status = "Cancelled", PaymentMethod = "Wallet", PaymentStatus = "Refunded", Note = "Đổi ý", CreatedAt = now.AddDays(-5), UpdatedAt = now.AddDays(-4) };
            var ord8 = new Order { Id = Guid.Parse("0d000000-0000-0000-0000-000000000008"), UserId = cust3.Id, ShopId = shop1.Id, ShippingAddressId = addr4.Id, Subtotal = 450000m, TotalAmount = 450000m, Status = "Completed", PaymentMethod = "Wallet", PaymentStatus = "Paid", CreatedAt = now.AddDays(-20), UpdatedAt = now.AddDays(-17) };
